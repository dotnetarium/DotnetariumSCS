...
namespace Dotnetarium.Config
{
    ...
    {
        private const string BuiltinConfigName = "DotnetariumSCS.Config.Main.yml";
        private const string ConfigName        = "DotnetariumSCS.Config.yml";
        private const string UserConfigName    = "DotnetariumSCS\\config-{0}.yml";
