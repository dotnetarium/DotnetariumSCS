...
namespace Dotnetarium.Analyzers.Locale
{
    internal class YamlResourceManager : ResourceManager
    {
        ...
        public YamlResourceManager() : base("DotnetariumSCS.Empty",
        ...
        private void Load()
        {
            ...
            using (Stream stream = assembly.GetManifestResourceStream("DotnetariumSCS.Config." + MessagesFileName))
